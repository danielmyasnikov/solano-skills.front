...
export const selectMainBasketTitle = ({ exercise }) => exercise.ranging.title;
export const selectItems = ({ exercise }) => exercise.ranging.items;
export const selectBaskets = ({ exercise }) => exercise.ranging.baskets;
export const selectMainBasket = ({ exercise }) => exercise.ranging.mainBasket;
