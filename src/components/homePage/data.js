...
export const slides = [
  ...
  },
  {
    ...
    items: [
      {
        bg: 'slideBg',
        title: 'Разработка Python пакетов',
        link: '/courses/developing-python-packages',
        text: 'В этом курсе вы узнаете о структуре пакетов и дополнительных файлах, необходимых для превращения кода в удобные пакеты.',
      },
      {
        bg: 'slideBg',
        title: 'Тестирование в Python',
        link: '/courses/unit-testing-python',
        text: 'Этот курс обучает модульному тестированию на Python с использованием самого популярного фреймворка для тестирования - pytest.',
      },
      {
        bg: 'slideBg',
        title: 'ООП в Python',
