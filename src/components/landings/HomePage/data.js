 ...
 */
  {
    ...
    items: [
      {
        bg: 'slideBg',
        title: 'Введение в Python для Data Science',
        link: '/courses/introduction-to-data-science-in-python',
        text: 'В этом курсе вы ознакомитесь с языком программирования Python и его применении в Data Science.',
      },
      {
        bg: 'slideBg',
        title: 'Типы данных для Data Science',
        link: '/courses/data-types-in-python-for-data-science',
        text: 'У вас есть базовые навыки программирования на Python для науки о данных, но вы жаждете большего? Тогда это курс для вас.',
      },
      {
        bg: 'slideBg',
        title: 'Обработка данных в pandas',
      ...
      {
        bg: 'slideBg',
        title: 'Понятие веб-скрапинга в Python',
        link: '/courses/web-scraping',
        text: 'Учимся извлекать нужные нам данные из интернета путём скрапинга и парсинга сайтов.',
      },
      {
        bg: 'slideBg',
        title: 'ООП в Python',
        link: '/courses/object-oriented-programming-python',
        text: 'Вы научитесь использовать принципы наследования и полиморфизма для повторного использования и оптимизации вашего кода.',
      },
      {
        bg: 'slideBg',
        title: 'Пишем эффективный код на Python',
        link: '/courses/writing-efficient-python-code',
        text: 'В этом курсе вы узнаете, как использовать встроенные структуры данных, функции и модули Python для написания более чистого, быстрого и эффективного кода.',
      },
      {
        bg: 'slideBg',
        title: 'Принципы разработки ПО на Python',
      ...
      },
      {
        ...
        link: '/courses/python-date-time',
        text: 'В рамках курса вы разберетесь как подсчитывать количество различных событий, определять временной интервал между событиями и отображать дату и время.',
      },
      {
        bg: 'slideBg',
      ...
      },
      {
        ...
        link: '/courses/functions-in-python',
        text: 'Вы узнаете как писать функции, контекстные менеджеры, декораторы.',
      },
      {
        bg: 'slideBg',
        title: 'Инструменты Python I',
        link: '/courses/python-toolbox-1',
        text: 'Курс об основных инструментах Python. Функции, аргументы, параметры, области видимости, лямбды.',
      },
      {
        bg: 'slideBg',
        title: 'Инструменты Python II',
        link: '/courses/python-toolbox-2',
        text: 'Продолжаем изучать инструменты Python. Итераторы, генераторы списков.',
      },
    ],
  },
];
