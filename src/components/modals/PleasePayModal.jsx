    ...
    <Modal open={true}>
      <Root>
        <div className="dropZone">
          ...
          <h2>Упс, эта часть курса недоступна</h2>
          <p>Для того, чтобы продолжить обучение, Вам необходимо приобрести подписку</p>
          <Button variant="containedGreen" onClick={() => dispatch(openTariffsModal({}))}>
            Активировать тариф
          </Button>
        </div>
      </Root>
